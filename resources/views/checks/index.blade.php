    ...
    <div class="container categories">
        <div class="row justify-content-center">
            ...
            @foreach($checks as $item)
                    ...
                    <div class="col-sm-2">
                        <div class="btn_group" style=" display: flex; ">
                            <a href="{{route('checks.edit', $item['id'])}}" class="btn btn-warning"><i class="far fa-edit"></i></a>
                            {{Form::open(['route'=>['checks.destroy', $item['id']], 'method'=>'delete', 'class'=>'inline_block'])}}
            ...
            <div class="col-sm-12 margin_top_50">
                <a href="{{route('checks.create')}}" class="btn btn-success display_block">Добавить чек</a>
            </div>
